...
namespace LicenseIssuanceService.Controllers
{
    ...
    public class LicenseIssuanceController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] LicenseIssuance licenseIssuance)
        {
            _context.LicenseIssuance.Add(licenseIssuance);
            await _context.SaveChangesAsync();
            return CreatedAtAction(nameof(Create), licenseIssuance);
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, LicenseIssuance licenseIssuance)
        {
